...
type APIMock struct {
	...
	funcDeleteCheckBundleByCID          func(cid apiclient.CIDType) (b1 bool, err error)
	inspectFuncDeleteCheckBundleByCID   func(cid apiclient.CIDType)
	afterDeleteCheckBundleByCIDCounter  uint64
	beforeDeleteCheckBundleByCIDCounter uint64
	DeleteCheckBundleByCIDMock          mAPIMockDeleteCheckBundleByCID
...
func NewAPIMock(t minimock.Tester) *APIMock {
	...
	m.DeleteCheckBundleByCIDMock = mAPIMockDeleteCheckBundleByCID{mock: m}
	m.DeleteCheckBundleByCIDMock.callArgs = []*APIMockDeleteCheckBundleByCIDParams{}
...
func (mmCreateCheckBundle *APIMock) CreateCheckBundle(cfg *apiclient.CheckBundle) (cp1 *apiclient.CheckBundle, err error) {
	...
	mm_params := &APIMockCreateCheckBundleParams{cfg}

	// Record call args
	mmCreateCheckBundle.CreateCheckBundleMock.mutex.Lock()
	mmCreateCheckBundle.CreateCheckBundleMock.callArgs = append(mmCreateCheckBundle.CreateCheckBundleMock.callArgs, mm_params)
	...
	if mmCreateCheckBundle.CreateCheckBundleMock.defaultExpectation != nil {
		...
		mm_want := mmCreateCheckBundle.CreateCheckBundleMock.defaultExpectation.params
		mm_got := APIMockCreateCheckBundleParams{cfg}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmCreateCheckBundle.t.Errorf("APIMock.CreateCheckBundle got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmCreateCheckBundle.CreateCheckBundleMock.defaultExpectation.results
		if mm_results == nil {
...
type mAPIMockDeleteCheckBundleByCID struct {
	mock               *APIMock
	defaultExpectation *APIMockDeleteCheckBundleByCIDExpectation
	expectations       []*APIMockDeleteCheckBundleByCIDExpectation

	callArgs []*APIMockDeleteCheckBundleByCIDParams
	mutex    sync.RWMutex
}

// APIMockDeleteCheckBundleByCIDExpectation specifies expectation struct of the API.DeleteCheckBundleByCID
type APIMockDeleteCheckBundleByCIDExpectation struct {
	mock    *APIMock
	params  *APIMockDeleteCheckBundleByCIDParams
	results *APIMockDeleteCheckBundleByCIDResults
	Counter uint64
}

// APIMockDeleteCheckBundleByCIDParams contains parameters of the API.DeleteCheckBundleByCID
type APIMockDeleteCheckBundleByCIDParams struct {
	cid apiclient.CIDType
}

// APIMockDeleteCheckBundleByCIDResults contains results of the API.DeleteCheckBundleByCID
type APIMockDeleteCheckBundleByCIDResults struct {
	b1  bool
	err error
}

// Expect sets up expected params for API.DeleteCheckBundleByCID
func (mmDeleteCheckBundleByCID *mAPIMockDeleteCheckBundleByCID) Expect(cid apiclient.CIDType) *mAPIMockDeleteCheckBundleByCID {
	if mmDeleteCheckBundleByCID.mock.funcDeleteCheckBundleByCID != nil {
		mmDeleteCheckBundleByCID.mock.t.Fatalf("APIMock.DeleteCheckBundleByCID mock is already set by Set")
	}

	if mmDeleteCheckBundleByCID.defaultExpectation == nil {
		mmDeleteCheckBundleByCID.defaultExpectation = &APIMockDeleteCheckBundleByCIDExpectation{}
	}

	mmDeleteCheckBundleByCID.defaultExpectation.params = &APIMockDeleteCheckBundleByCIDParams{cid}
	for _, e := range mmDeleteCheckBundleByCID.expectations {
		if minimock.Equal(e.params, mmDeleteCheckBundleByCID.defaultExpectation.params) {
			mmDeleteCheckBundleByCID.mock.t.Fatalf("Expectation set by When has same params: %#v", *mmDeleteCheckBundleByCID.defaultExpectation.params)
		}
	}

	return mmDeleteCheckBundleByCID
}

// Inspect accepts an inspector function that has same arguments as the API.DeleteCheckBundleByCID
func (mmDeleteCheckBundleByCID *mAPIMockDeleteCheckBundleByCID) Inspect(f func(cid apiclient.CIDType)) *mAPIMockDeleteCheckBundleByCID {
	if mmDeleteCheckBundleByCID.mock.inspectFuncDeleteCheckBundleByCID != nil {
		mmDeleteCheckBundleByCID.mock.t.Fatalf("Inspect function is already set for APIMock.DeleteCheckBundleByCID")
	}

	mmDeleteCheckBundleByCID.mock.inspectFuncDeleteCheckBundleByCID = f

	return mmDeleteCheckBundleByCID
}

// Return sets up results that will be returned by API.DeleteCheckBundleByCID
func (mmDeleteCheckBundleByCID *mAPIMockDeleteCheckBundleByCID) Return(b1 bool, err error) *APIMock {
	if mmDeleteCheckBundleByCID.mock.funcDeleteCheckBundleByCID != nil {
		mmDeleteCheckBundleByCID.mock.t.Fatalf("APIMock.DeleteCheckBundleByCID mock is already set by Set")
	}

	if mmDeleteCheckBundleByCID.defaultExpectation == nil {
		mmDeleteCheckBundleByCID.defaultExpectation = &APIMockDeleteCheckBundleByCIDExpectation{mock: mmDeleteCheckBundleByCID.mock}
	}
	mmDeleteCheckBundleByCID.defaultExpectation.results = &APIMockDeleteCheckBundleByCIDResults{b1, err}
	return mmDeleteCheckBundleByCID.mock
}

//Set uses given function f to mock the API.DeleteCheckBundleByCID method
func (mmDeleteCheckBundleByCID *mAPIMockDeleteCheckBundleByCID) Set(f func(cid apiclient.CIDType) (b1 bool, err error)) *APIMock {
	if mmDeleteCheckBundleByCID.defaultExpectation != nil {
		mmDeleteCheckBundleByCID.mock.t.Fatalf("Default expectation is already set for the API.DeleteCheckBundleByCID method")
	}

	if len(mmDeleteCheckBundleByCID.expectations) > 0 {
		mmDeleteCheckBundleByCID.mock.t.Fatalf("Some expectations are already set for the API.DeleteCheckBundleByCID method")
	}

	mmDeleteCheckBundleByCID.mock.funcDeleteCheckBundleByCID = f
	return mmDeleteCheckBundleByCID.mock
}

// When sets expectation for the API.DeleteCheckBundleByCID which will trigger the result defined by the following
// Then helper
func (mmDeleteCheckBundleByCID *mAPIMockDeleteCheckBundleByCID) When(cid apiclient.CIDType) *APIMockDeleteCheckBundleByCIDExpectation {
	if mmDeleteCheckBundleByCID.mock.funcDeleteCheckBundleByCID != nil {
		mmDeleteCheckBundleByCID.mock.t.Fatalf("APIMock.DeleteCheckBundleByCID mock is already set by Set")
	}

	expectation := &APIMockDeleteCheckBundleByCIDExpectation{
		mock:   mmDeleteCheckBundleByCID.mock,
		params: &APIMockDeleteCheckBundleByCIDParams{cid},
	}
	mmDeleteCheckBundleByCID.expectations = append(mmDeleteCheckBundleByCID.expectations, expectation)
	return expectation
}

// Then sets up API.DeleteCheckBundleByCID return parameters for the expectation previously defined by the When method
func (e *APIMockDeleteCheckBundleByCIDExpectation) Then(b1 bool, err error) *APIMock {
	e.results = &APIMockDeleteCheckBundleByCIDResults{b1, err}
	return e.mock
}

// DeleteCheckBundleByCID implements API
func (mmDeleteCheckBundleByCID *APIMock) DeleteCheckBundleByCID(cid apiclient.CIDType) (b1 bool, err error) {
	mm_atomic.AddUint64(&mmDeleteCheckBundleByCID.beforeDeleteCheckBundleByCIDCounter, 1)
	defer mm_atomic.AddUint64(&mmDeleteCheckBundleByCID.afterDeleteCheckBundleByCIDCounter, 1)

	if mmDeleteCheckBundleByCID.inspectFuncDeleteCheckBundleByCID != nil {
		mmDeleteCheckBundleByCID.inspectFuncDeleteCheckBundleByCID(cid)
	}

	mm_params := &APIMockDeleteCheckBundleByCIDParams{cid}

	// Record call args
	mmDeleteCheckBundleByCID.DeleteCheckBundleByCIDMock.mutex.Lock()
	mmDeleteCheckBundleByCID.DeleteCheckBundleByCIDMock.callArgs = append(mmDeleteCheckBundleByCID.DeleteCheckBundleByCIDMock.callArgs, mm_params)
	mmDeleteCheckBundleByCID.DeleteCheckBundleByCIDMock.mutex.Unlock()

	for _, e := range mmDeleteCheckBundleByCID.DeleteCheckBundleByCIDMock.expectations {
		if minimock.Equal(e.params, mm_params) {
			mm_atomic.AddUint64(&e.Counter, 1)
	...
	if mmDeleteCheckBundleByCID.DeleteCheckBundleByCIDMock.defaultExpectation != nil {
		mm_atomic.AddUint64(&mmDeleteCheckBundleByCID.DeleteCheckBundleByCIDMock.defaultExpectation.Counter, 1)
		mm_want := mmDeleteCheckBundleByCID.DeleteCheckBundleByCIDMock.defaultExpectation.params
		mm_got := APIMockDeleteCheckBundleByCIDParams{cid}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmDeleteCheckBundleByCID.t.Errorf("APIMock.DeleteCheckBundleByCID got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmDeleteCheckBundleByCID.DeleteCheckBundleByCIDMock.defaultExpectation.results
		if mm_results == nil {
			mmDeleteCheckBundleByCID.t.Fatal("No results are set for the APIMock.DeleteCheckBundleByCID")
		}
		return (*mm_results).b1, (*mm_results).err
	}
	if mmDeleteCheckBundleByCID.funcDeleteCheckBundleByCID != nil {
		return mmDeleteCheckBundleByCID.funcDeleteCheckBundleByCID(cid)
	}
	mmDeleteCheckBundleByCID.t.Fatalf("Unexpected call to APIMock.DeleteCheckBundleByCID. %v", cid)
	return
}

// DeleteCheckBundleByCIDAfterCounter returns a count of finished APIMock.DeleteCheckBundleByCID invocations
func (mmDeleteCheckBundleByCID *APIMock) DeleteCheckBundleByCIDAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmDeleteCheckBundleByCID.afterDeleteCheckBundleByCIDCounter)
}

// DeleteCheckBundleByCIDBeforeCounter returns a count of APIMock.DeleteCheckBundleByCID invocations
func (mmDeleteCheckBundleByCID *APIMock) DeleteCheckBundleByCIDBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmDeleteCheckBundleByCID.beforeDeleteCheckBundleByCIDCounter)
}

// Calls returns a list of arguments used in each call to APIMock.DeleteCheckBundleByCID.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmDeleteCheckBundleByCID *mAPIMockDeleteCheckBundleByCID) Calls() []*APIMockDeleteCheckBundleByCIDParams {
	mmDeleteCheckBundleByCID.mutex.RLock()

	argCopy := make([]*APIMockDeleteCheckBundleByCIDParams, len(mmDeleteCheckBundleByCID.callArgs))
	copy(argCopy, mmDeleteCheckBundleByCID.callArgs)

	mmDeleteCheckBundleByCID.mutex.RUnlock()

	return argCopy
}

// MinimockDeleteCheckBundleByCIDDone returns true if the count of the DeleteCheckBundleByCID invocations corresponds
// the number of defined expectations
func (m *APIMock) MinimockDeleteCheckBundleByCIDDone() bool {
	for _, e := range m.DeleteCheckBundleByCIDMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			return false
		}
	}
	...
	// if default expectation was set then invocations count should be greater than zero
	if m.DeleteCheckBundleByCIDMock.defaultExpectation != nil && mm_atomic.LoadUint64(&m.afterDeleteCheckBundleByCIDCounter) < 1 {
		return false
	}
	// if func was set then invocations count should be greater than zero
	if m.funcDeleteCheckBundleByCID != nil && mm_atomic.LoadUint64(&m.afterDeleteCheckBundleByCIDCounter) < 1 {
		return false
	}
	return true
}

// MinimockDeleteCheckBundleByCIDInspect logs each unmet expectation
func (m *APIMock) MinimockDeleteCheckBundleByCIDInspect() {
	for _, e := range m.DeleteCheckBundleByCIDMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to APIMock.DeleteCheckBundleByCID with params: %#v", *e.params)
		}
	}

	// if default expectation was set then invocations count should be greater than zero
	if m.DeleteCheckBundleByCIDMock.defaultExpectation != nil && mm_atomic.LoadUint64(&m.afterDeleteCheckBundleByCIDCounter) < 1 {
		if m.DeleteCheckBundleByCIDMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to APIMock.DeleteCheckBundleByCID")
		} else {
			m.t.Errorf("Expected call to APIMock.DeleteCheckBundleByCID with params: %#v", *m.DeleteCheckBundleByCIDMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcDeleteCheckBundleByCID != nil && mm_atomic.LoadUint64(&m.afterDeleteCheckBundleByCIDCounter) < 1 {
...
func (mmFetchBroker *APIMock) FetchBroker(cid apiclient.CIDType) (bp1 *apiclient.Broker, err error) {
	...
	mm_params := &APIMockFetchBrokerParams{cid}

	// Record call args
	mmFetchBroker.FetchBrokerMock.mutex.Lock()
	mmFetchBroker.FetchBrokerMock.callArgs = append(mmFetchBroker.FetchBrokerMock.callArgs, mm_params)
	...
	if mmFetchBroker.FetchBrokerMock.defaultExpectation != nil {
		...
		mm_want := mmFetchBroker.FetchBrokerMock.defaultExpectation.params
		mm_got := APIMockFetchBrokerParams{cid}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmFetchBroker.t.Errorf("APIMock.FetchBroker got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmFetchBroker.FetchBrokerMock.defaultExpectation.results
		if mm_results == nil {
...
func (mmFetchBrokers *APIMock) FetchBrokers() (bap1 *[]apiclient.Broker, err error) {
	...
	if mmFetchBrokers.FetchBrokersMock.defaultExpectation != nil {
		...
		mm_results := mmFetchBrokers.FetchBrokersMock.defaultExpectation.results
		if mm_results == nil {
			mmFetchBrokers.t.Fatal("No results are set for the APIMock.FetchBrokers")
		}
		return (*mm_results).bap1, (*mm_results).err
	}
...
func (mmFetchCheck *APIMock) FetchCheck(cid apiclient.CIDType) (cp1 *apiclient.Check, err error) {
	...
	mm_params := &APIMockFetchCheckParams{cid}

	// Record call args
	mmFetchCheck.FetchCheckMock.mutex.Lock()
	mmFetchCheck.FetchCheckMock.callArgs = append(mmFetchCheck.FetchCheckMock.callArgs, mm_params)
	...
	if mmFetchCheck.FetchCheckMock.defaultExpectation != nil {
		...
		mm_want := mmFetchCheck.FetchCheckMock.defaultExpectation.params
		mm_got := APIMockFetchCheckParams{cid}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmFetchCheck.t.Errorf("APIMock.FetchCheck got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmFetchCheck.FetchCheckMock.defaultExpectation.results
		if mm_results == nil {
...
func (mmFetchCheckBundle *APIMock) FetchCheckBundle(cid apiclient.CIDType) (cp1 *apiclient.CheckBundle, err error) {
	...
	mm_params := &APIMockFetchCheckBundleParams{cid}

	// Record call args
	mmFetchCheckBundle.FetchCheckBundleMock.mutex.Lock()
	mmFetchCheckBundle.FetchCheckBundleMock.callArgs = append(mmFetchCheckBundle.FetchCheckBundleMock.callArgs, mm_params)
	...
	if mmFetchCheckBundle.FetchCheckBundleMock.defaultExpectation != nil {
		...
		mm_want := mmFetchCheckBundle.FetchCheckBundleMock.defaultExpectation.params
		mm_got := APIMockFetchCheckBundleParams{cid}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmFetchCheckBundle.t.Errorf("APIMock.FetchCheckBundle got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmFetchCheckBundle.FetchCheckBundleMock.defaultExpectation.results
		if mm_results == nil {
...
func (mmFetchCheckBundleMetrics *APIMock) FetchCheckBundleMetrics(cid apiclient.CIDType) (cp1 *apiclient.CheckBundleMetrics, err error) {
	...
	mm_params := &APIMockFetchCheckBundleMetricsParams{cid}

	// Record call args
	mmFetchCheckBundleMetrics.FetchCheckBundleMetricsMock.mutex.Lock()
	mmFetchCheckBundleMetrics.FetchCheckBundleMetricsMock.callArgs = append(mmFetchCheckBundleMetrics.FetchCheckBundleMetricsMock.callArgs, mm_params)
	...
	if mmFetchCheckBundleMetrics.FetchCheckBundleMetricsMock.defaultExpectation != nil {
		...
		mm_want := mmFetchCheckBundleMetrics.FetchCheckBundleMetricsMock.defaultExpectation.params
		mm_got := APIMockFetchCheckBundleMetricsParams{cid}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmFetchCheckBundleMetrics.t.Errorf("APIMock.FetchCheckBundleMetrics got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmFetchCheckBundleMetrics.FetchCheckBundleMetricsMock.defaultExpectation.results
		if mm_results == nil {
...
func (mmGet *APIMock) Get(url string) (ba1 []byte, err error) {
	...
	mm_params := &APIMockGetParams{url}
...
func (mmSearchCheckBundles *APIMock) SearchCheckBundles(searchCriteria *apiclient.SearchQueryType, filterCriteria *apiclient.SearchFilterType) (cap1 *[]apiclient.CheckBundle, err error) {
	...
	mm_params := &APIMockSearchCheckBundlesParams{searchCriteria, filterCriteria}

	// Record call args
	mmSearchCheckBundles.SearchCheckBundlesMock.mutex.Lock()
	mmSearchCheckBundles.SearchCheckBundlesMock.callArgs = append(mmSearchCheckBundles.SearchCheckBundlesMock.callArgs, mm_params)
	...
	if mmSearchCheckBundles.SearchCheckBundlesMock.defaultExpectation != nil {
		...
		mm_want := mmSearchCheckBundles.SearchCheckBundlesMock.defaultExpectation.params
		mm_got := APIMockSearchCheckBundlesParams{searchCriteria, filterCriteria}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmSearchCheckBundles.t.Errorf("APIMock.SearchCheckBundles got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmSearchCheckBundles.SearchCheckBundlesMock.defaultExpectation.results
		if mm_results == nil {
...
func (mmUpdateCheckBundle *APIMock) UpdateCheckBundle(cfg *apiclient.CheckBundle) (cp1 *apiclient.CheckBundle, err error) {
	...
	mm_params := &APIMockUpdateCheckBundleParams{cfg}

	// Record call args
	mmUpdateCheckBundle.UpdateCheckBundleMock.mutex.Lock()
	mmUpdateCheckBundle.UpdateCheckBundleMock.callArgs = append(mmUpdateCheckBundle.UpdateCheckBundleMock.callArgs, mm_params)
	...
	if mmUpdateCheckBundle.UpdateCheckBundleMock.defaultExpectation != nil {
		...
		mm_want := mmUpdateCheckBundle.UpdateCheckBundleMock.defaultExpectation.params
		mm_got := APIMockUpdateCheckBundleParams{cfg}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmUpdateCheckBundle.t.Errorf("APIMock.UpdateCheckBundle got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmUpdateCheckBundle.UpdateCheckBundleMock.defaultExpectation.results
		if mm_results == nil {
...
func (mmUpdateCheckBundleMetrics *APIMock) UpdateCheckBundleMetrics(cfg *apiclient.CheckBundleMetrics) (cp1 *apiclient.CheckBundleMetrics, err error) {
	...
	mm_params := &APIMockUpdateCheckBundleMetricsParams{cfg}

	// Record call args
	mmUpdateCheckBundleMetrics.UpdateCheckBundleMetricsMock.mutex.Lock()
	mmUpdateCheckBundleMetrics.UpdateCheckBundleMetricsMock.callArgs = append(mmUpdateCheckBundleMetrics.UpdateCheckBundleMetricsMock.callArgs, mm_params)
	...
	if mmUpdateCheckBundleMetrics.UpdateCheckBundleMetricsMock.defaultExpectation != nil {
		...
		mm_want := mmUpdateCheckBundleMetrics.UpdateCheckBundleMetricsMock.defaultExpectation.params
		mm_got := APIMockUpdateCheckBundleMetricsParams{cfg}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmUpdateCheckBundleMetrics.t.Errorf("APIMock.UpdateCheckBundleMetrics got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmUpdateCheckBundleMetrics.UpdateCheckBundleMetricsMock.defaultExpectation.results
		if mm_results == nil {
...
func (m *APIMock) MinimockFinish() {
	if !m.minimockDone() {
		...
		m.MinimockDeleteCheckBundleByCIDInspect()
...
func (m *APIMock) minimockDone() bool {
	...
	return done &&
		...
		m.MinimockDeleteCheckBundleByCIDDone() &&
