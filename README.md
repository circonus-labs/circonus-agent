...
| `ms` | Timing - treated as a Circonus Histogram |
| `s`  | Sets - coerced into Counter              |
| `t`  | Text - Circonus specific                 |

>NOTE: the derivative metrics automatically generated by some StatsD type are not created by Circonus as the data is already available
